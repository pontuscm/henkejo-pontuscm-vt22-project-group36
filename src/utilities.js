...
function sortDishes(dishes){
    ...
    return sortedDishes.sort(compareDishTypeCB)
}
...
function menuPrice(dishesArray){
    ...
    function sumTwoParameters(parameterA, parameterB){
    ...
    const priceArray = dishesArray.map(dishPriceCB)
    ...
    return priceArray.reduce(sumTwoParameters, 0)
